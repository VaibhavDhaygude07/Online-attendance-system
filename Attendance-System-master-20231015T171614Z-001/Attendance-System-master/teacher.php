        ...
        <div class="modal-content">
          ...
          <hr>
            <div id="add_class_form">
              ...
              <input class="form-control" name="code" placeholder="Code , Eg : PCE-501">
              ...
              <input class="form-control" name="start" placeholder="Starting Roll Number (Eg. 501/IP/23)">
              <input class="form-control" name="end" placeholder="Ending Roll Number (Eg. 565/IP/23)">
